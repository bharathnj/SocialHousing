        ...
        <div class="reveal">
            ...
            <div class="slides">
                ...
                <section>
                    ...
                    <h4><strong>Module 6</strong></h4><br><br>
                    <h2><strong>CIBIL (Credit Information Bureau (India) Limited) Score</strong></h2>
                </section>
                <section>
                        ...
                        <div class="row">
                            <div class="col m6 left-align">
                                ...
                                <ul>
                                    <span class="fragment">
                                        <li>
                                            Understanding of CIBIL and its importance
                                        </li>
                                    </span>
                                    <span class="fragment">
                                        <li>
                                            Methods to improve CIBIL
                                        </li>
                                    </span>
                                </ul>
                            </div>
                            <div class="col m6">
                                <img src="../images/Module6/intro.png" width="500" >
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col m12 ">
                                <p>
                                    <a href="https://www.bankbazaar.com/cibil/tips-to-increase-cibil-credit-score.html" target="_blank">
                                        Click to increase CIBIL Score
                                    </a>
                                </p>
                                <p> 
