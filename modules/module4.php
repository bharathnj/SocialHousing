...
<html lang="en">
    ...
    <head>
        ...
        <title>Social Housing - Present SOCIALHOUSING to the buyers of a company</title>
        ...
        <div class="reveal">
            ...
            <div class="slides">
                ...
                <section>
                    ...
                    <h4><strong>Module 4</strong></h4><br><br>
                    <h2><strong>Meet the Home Seeker(s)</strong></h2>
                </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col m6 left-align">
                                ...
                                <ul>
                                    <span class="fragment"> 
                                        <li>
                                            Flow of steps during communication with the home seeker
                                        </li>
                                    </span>
                                </ul>
                            </div>
                            <div class="col m6">
                                <img src="../images/Module4/intro.jpg" height="300">
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col m12 left-align">
                                <img src="../images/Module4/steps.png">
                            </div>
                        </div>
                    </div>
                </section>
